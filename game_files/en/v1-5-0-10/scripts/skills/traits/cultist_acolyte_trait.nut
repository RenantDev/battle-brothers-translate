this.cultist_acolyte_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Description = "This character is an acolyte of Davkul, an individual with intimate knowledge of the teachings about the elder god. He embraces physical pain and peril as bringing him closer to salvation.";
