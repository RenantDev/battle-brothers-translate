...
WorldTownScreenTavernDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mDialogContainer = this.mContainer.createDialog('Tavern', '', '', true, 'dialog-1024-768');
	...
	this.mLeftDetailsPanel.Name = $('<div class="name title-font-normal font-bold font-color-brother-name">Share news and rumors with the patrons</div>');
    ...
    this.mLeftDetailsPanel.Button = hireButtonLayout.createTextButton("Pay", function()
	{
	...
	this.mRightDetailsPanel.Name = $('<div class="name title-font-normal font-bold font-color-brother-name">Pay a round for your men</div>');
    backgroundRow.append(this.mRightDetailsPanel.Name);
    backgroundRow = $('<div class="row is-bottom"/>');
    detailsColumn.append(backgroundRow);

	this.mRightDetailsPanel.Info = $('<div class="column text-font-medium font-bottom-shadow font-color-description is-action-description">Pay a round for your men</div>');
