this.cultist_disciple_trait <- this.inherit("scripts/skills/traits/character_trait", {
	...
	function create()
	{
		...
		this.m.Description = "This character is a disciple of Davkul, an individual with unquestionable loyalty to the elder god. He embraces physical pain and peril as bringing him closer to salvation.";
