this.craftable_kraken_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Shield Kraken";
		this.m.Description = "Este escudo, esculpido de uma placa de chifre retirada de um kraken gigante, é mais forte que qualquer escudo comum.";
