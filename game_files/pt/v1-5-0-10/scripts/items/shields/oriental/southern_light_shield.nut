this.southern_light_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Description = "Um escudo de madeira claro com uma moldura de metal, coberta de couro.Oferece boa proteção contra ataques variados devido ao seu tamanho, mas não é muito robusto.";
