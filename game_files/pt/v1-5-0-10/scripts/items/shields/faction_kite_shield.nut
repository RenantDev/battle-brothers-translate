this.faction_kite_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Description = "Um escudo de madeira alongado coberto de couro que oferece boa proteção também para a parte inferior do corpo.Um pouco volumoso para lidar com engajamentos de combate próximos.";
