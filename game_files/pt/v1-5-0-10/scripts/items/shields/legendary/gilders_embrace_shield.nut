this.gilders_embrace_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Abraço de Gilder \ '";
		this.m.Description = "Um escudo de metal ornamentado com um brilho dourado brilhante que reflete até mesmo o menor raio de luz com o poder do próprio sol.";
