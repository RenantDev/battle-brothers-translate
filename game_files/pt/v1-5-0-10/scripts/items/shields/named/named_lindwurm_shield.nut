this.named_lindwurm_shield <- this.inherit("scripts/items/shields/named/named_shield", {
	...
	function create()
	{
		...
		this.m.Description = "Um quadro de madeira resistente estabelece a base para um monte cintilante de escalas de Lindwurm raras para formar um impenetrável de escudo.";
