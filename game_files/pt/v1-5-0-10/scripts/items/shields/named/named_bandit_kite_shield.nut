this.named_bandit_kite_shield <- this.inherit("scripts/items/shields/named/named_shield", {
	...
	function create()
	{
		...
		this.m.Description = "Um escudo longo e de madeira cobrindo todo o corpo para uma boa proteção contra ataques variados.Este escudo em particular mostra algum artesanato único e é um achado raro.";
