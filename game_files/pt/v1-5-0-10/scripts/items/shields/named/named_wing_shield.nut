this.named_wing_shield <- this.inherit("scripts/items/shields/named/named_shield", {
	...
	function create()
	{
		...
		this.m.Description = "Um escudo de aquecedor de madeira reforçado feito dos melhores materiais e bastante obviamente criado por um fabricante de escudo mestre.";
