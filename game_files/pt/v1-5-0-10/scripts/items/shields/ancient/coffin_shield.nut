this.coffin_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Antiga escudo de caixão";
		this.m.Description = "Um escudo octogonal feito de madeira e reforçado com bronze.O tempo levou seu pedágio e a madeira ficou frágil.";
