this.tower_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Escudo da torre antiga";
		this.m.Description = "Um escudo de torre alto e pesado que oferece boa proteção, mas é muito volumoso para lidar.Parece ser velho e desgastado.";
