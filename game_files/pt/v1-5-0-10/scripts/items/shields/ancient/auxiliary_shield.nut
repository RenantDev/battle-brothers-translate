this.auxiliary_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Escudo Auxiliar antigo";
		this.m.Description = "Um escudo de luz de madeira na forma oval.A madeira parece frágil e velha, tornando-se menos durável.";
