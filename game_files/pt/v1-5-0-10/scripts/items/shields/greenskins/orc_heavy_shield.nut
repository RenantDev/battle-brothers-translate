this.orc_heavy_shield <- this.inherit("scripts/items/shields/shield", {
	...
	function create()
	{
		...
		this.m.Name = "Escudo de metal pesado";
		this.m.Description = "Um maciço escudo de metal que é quase impossível de destruir, mas muito pesado e fatal para usar para qualquer humano.";
