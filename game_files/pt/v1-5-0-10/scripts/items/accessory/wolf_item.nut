this.wolf_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function create()
	{
		...
		this.m.Description = "Um lobo forte e selvagem, domado para ser um companheiro leal na batalha.Pode ser desencadeado em batalha pelo scouting, rastreando ou correndo inimigos de roteamento.";
