this.recovery_potion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Segunda poção eólica";
		this.m.Description = "Um lutador fatigado é um lutador morto.Esta mistura de estimulantes de adrenalina e plantas pode ser usada para ir a milha extra.Dura a próxima batalha.";
