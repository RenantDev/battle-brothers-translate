this.heavily_armored_warhound_item <- this.inherit("scripts/items/accessory/warhound_item", {
	...
	function create()
	{
		...
		this.m.Description = "Um forte e leal Hound do norte criado para a guerra.Pode ser desencadeado em batalha pelo scouting, rastreando ou correndo inimigos de roteamento.Este usa um casaco de esconderijo pesado para proteção.";
