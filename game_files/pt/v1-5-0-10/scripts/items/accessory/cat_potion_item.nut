this.cat_potion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de gato.";
		this.m.Description = "Seja rápido como um gato!Esta poção promete aumentar seus sentidos e afiar seus reflexos.Beber com responsabilidade.Dura a próxima batalha.";
