this.spider_poison_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function create()
	{
		...
		this.m.Name = "Óleo envenenado";
		this.m.Description = "Um frasco de óleo atado com veneno de webknecht concentrado.Pode ser usado para cobrir suas armas e arrowtips.";
