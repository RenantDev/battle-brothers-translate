this.iron_will_potion_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Ferro vai poção.";
		this.m.Description = "Uma bebida para entorpecer a dor e obter os sucos fluindo.Espere uma grande sensação de queima em sua garganta.Beber com responsabilidade.Dura a próxima batalha.";
