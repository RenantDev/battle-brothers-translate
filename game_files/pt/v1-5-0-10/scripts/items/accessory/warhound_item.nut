this.warhound_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function create()
	{
		...
		this.m.Description = "Um forte e leal Hound do norte criado para a guerra.Pode ser desencadeado em batalha pelo scouting, rastreando ou correndo inimigos de roteamento.";
