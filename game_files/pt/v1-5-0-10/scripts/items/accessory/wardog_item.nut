this.wardog_item <- this.inherit("scripts/items/accessory/accessory", {
	...
	function create()
	{
		...
		this.m.Description = "Um cão forte e leal criado para a guerra.Pode ser desencadeado em batalha pelo scouting, rastreando ou correndo inimigos de roteamento.";
