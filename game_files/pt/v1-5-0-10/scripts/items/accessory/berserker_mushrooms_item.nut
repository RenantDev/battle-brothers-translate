this.berserker_mushrooms_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Cogumelos estranhos";
		this.m.Description = "Cogumelos estranhos que alguém que as que as queixam entram em um estado de raiva parecido em transe, onde não sentem nenhuma dor e exibem significativamente aumentaram a agressão.Comer com responsabilidade.Dura a próxima batalha.";
