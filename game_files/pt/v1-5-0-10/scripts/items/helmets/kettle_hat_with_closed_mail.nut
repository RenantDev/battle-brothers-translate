this.kettle_hat_with_closed_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Chapéu de chaleira com correio fechado";
		this.m.Description = "Um capacete de metal completo com uma borda larga e um cofre de correio cobrindo o pescoço e o rosto.";
