this.rusty_mail_coif <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Coifa de correio enferrujado";
		this.m.Description = "Um coifa de correio enferrujado que ainda oferece boa proteção - deixa manchas horríveis embora.";
