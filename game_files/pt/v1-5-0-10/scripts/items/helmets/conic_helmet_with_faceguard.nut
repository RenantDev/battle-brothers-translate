this.conic_helmet_with_faceguard <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete cônico com faceguard";
		this.m.Description = "Este capacete cônico com correio tem uma faceguard de metal anexado.É pesado e difícil ver através, mas oferece excelente proteção.";
