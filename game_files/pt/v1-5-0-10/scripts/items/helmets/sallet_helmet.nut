this.sallet_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete Sallet.";
		this.m.Description = "Um capacete de metal com um decote em decote prolongado, um design incomum nessas terras.É bem trabalhado para oferecer proteção máxima com peso mínimo e sem comprometer a visão.";
