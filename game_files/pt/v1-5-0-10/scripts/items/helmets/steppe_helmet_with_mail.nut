this.steppe_helmet_with_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete de estepe com email";
		this.m.Description = "Uma bruxa de capacete nasal uma guarda de notas de correio anexado na forma do pessoal da estepe.";
