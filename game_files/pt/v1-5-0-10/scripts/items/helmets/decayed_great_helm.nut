this.decayed_great_helm <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Grande elmo decaído";
		this.m.Description = "Um grande capacete com decorações rasgadas e podres.Deve ter pertencido uma vez a um renomado cavaleiro.";
