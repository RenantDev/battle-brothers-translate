this.ijirok_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete do Ijirok";
		this.m.Description = "Uma vez que um capacete bárbaro quebrado na batalha, esta peça foi banhada no sangue do lendário Ijirok.Powers além de sua compreensão consertou tudo de novo, e também consertará nenhuma ferida do usuário também.";
