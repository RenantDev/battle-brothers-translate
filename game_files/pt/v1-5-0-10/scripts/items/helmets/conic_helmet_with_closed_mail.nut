this.conic_helmet_with_closed_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete cônico com correio fechado";
		this.m.Description = "Um capacete cônico pesado com uma saia de correspondência fechada para proteção adicional.";
