this.closed_flat_top_with_neckguard <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Top plano fechado e acolchoado";
		this.m.Description = "Um capacete fechado com faceguard completa e um coifado acolchoado embaixo.Difícil respirar e limitar o campo de visão.";
