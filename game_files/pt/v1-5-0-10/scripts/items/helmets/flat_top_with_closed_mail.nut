this.flat_top_with_closed_mail <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Parte superior plana com correio fechado";
		this.m.Description = "Um capacete de metal completo com um cofre de correio cobrindo o pescoço e o rosto.";
