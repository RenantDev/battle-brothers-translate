this.full_helm <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Elmo completo";
		this.m.Description = "Um leme de metal fechado com furos respiratórios.Ótimo no caminho da proteção, mas difícil de respirar e limitar o campo de visão.";
