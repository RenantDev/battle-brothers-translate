this.closed_scrap_metal_helmet <- this.inherit("scripts/items/helmets/helmet", {
	...
	function create()
	{
		...
		this.m.Name = "Capacete de sucata fechada";
		this.m.Description = "Este capacete de metal pesado também protege o rosto do usuário, embora ao custo de visibilidade.";
