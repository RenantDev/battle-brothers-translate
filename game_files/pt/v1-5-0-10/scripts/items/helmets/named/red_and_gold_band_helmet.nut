this.red_and_gold_band_helmet <- this.inherit("scripts/items/helmets/named/named_helmet", {
	...
	function create()
	{
		...
		this.m.Description = "Este capacete de estilo sul é não apenas ricamente decorado, mas também bem equilibrado e feito de metais extremamente de alta qualidade.";
		this.m.NameList = [
			"Splinted Helmet",
			"Segmented Helmet",
