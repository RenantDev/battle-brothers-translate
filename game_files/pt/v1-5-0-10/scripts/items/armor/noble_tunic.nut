this.noble_tunic <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Túnica nobre.";
		this.m.Description = "Uma túnica de linho fino de material requintado, bordado com padrões agradáveis.Na moda, mas oferecendo pouco na proteção.";
