this.emperors_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Description = "Uma armadura brilhante, uma vez usada pelo imperador de uma idade passada, feita a partir do mais maravilhoso dos materiais, imbuída de energias místicas.A luz reflete facilmente a armadura polida, transformando o usuário em uma figura cintilante de luz durante o dia.";
