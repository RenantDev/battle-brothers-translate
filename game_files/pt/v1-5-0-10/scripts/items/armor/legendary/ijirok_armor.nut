this.ijirok_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Armadura do Ijirok";
		this.m.Description = "Uma vez que uma armadura bárbara quebrada em batalha, esta peça foi banhada no sangue do lendário Ijirok.Powers além de sua compreensão consertou tudo de novo, e também consertará nenhuma ferida do usuário também.";
