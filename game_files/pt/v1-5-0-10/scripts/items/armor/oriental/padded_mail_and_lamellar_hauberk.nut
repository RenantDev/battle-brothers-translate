this.padded_mail_and_lamellar_hauberk <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Cala acolchoado e lamellar Hauberk";
		this.m.Description = "Uma pesada armadura composta consistindo de casaco de correio, preenchimento e elementos lamelares.";
