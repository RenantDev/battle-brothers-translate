this.heraldic_armor <- this.inherit("scripts/items/armor/armor", {
	...
	function create()
	{
		...
		this.m.Name = "Hauberk heráldico";
		this.m.Description = "Um email Hauberk reforçado com os ombros Pauldrons, plating de metal adicional e uma armadura de couro rebitada, coberta com uma tabela em uma nobre casas \ 'cores.";
