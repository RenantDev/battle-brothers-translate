this.leopard_armor <- this.inherit("scripts/items/armor/named/named_armor", {
	...
	function create()
	{
		...
		this.m.Description = "Um arnês de placa lamelar pesado combinado com correio fino e acolchoamento confortável.Uma peça verdadeiramente bem feita que é quase preciosa demais para ser rasgada em batalha.";
		this.m.NameList = [
			"Gilder\'s Embrace",
			"Gilder\'s Guard",
			"Glistening Lamellar",
