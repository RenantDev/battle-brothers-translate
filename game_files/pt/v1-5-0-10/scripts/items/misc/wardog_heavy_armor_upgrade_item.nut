this.wardog_heavy_armor_upgrade_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Armadura de guarda pesada";
		this.m.Description = "Um casaco pesado de esconderijo que pode ser conduzido por qualquer guarda para dar proteção em combate.";
