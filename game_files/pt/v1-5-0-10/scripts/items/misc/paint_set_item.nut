this.paint_set_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Pintar conjunto";
		this.m.Description = "Uma paleta de várias cores vibrantes e um conjunto de escovas.Pode ser usado para pintar escudos comuns nas cores da sua empresa.";
