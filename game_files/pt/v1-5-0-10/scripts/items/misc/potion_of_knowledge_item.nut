this.potion_of_knowledge_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção do conhecimento";
		this.m.Description = "Conhecimento do mundo, arcano e mundano, é dito ser destilado nessa poção.Ao beber, as lições são mais facilmente aprendidas.";
