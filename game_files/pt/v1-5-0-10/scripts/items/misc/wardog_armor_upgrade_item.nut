this.wardog_armor_upgrade_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Armadura de Wardog.";
		this.m.Description = "Um casaco de couro simples que pode ser usado por qualquer guarda-via para dar alguma proteção em combate.";
