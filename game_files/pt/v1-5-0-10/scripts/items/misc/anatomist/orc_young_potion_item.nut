this.orc_young_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Esboço do cinetista";
		this.m.Description = "Sinta a força de um orc fluir através de suas veias!Imbibing este rascunho vai infundir até os funcionários mais mansídricos com o intenso poder destrutivo de um Hulking Greenskin, garantido!";
		this.m.IconLarge = "";
