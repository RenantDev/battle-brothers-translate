this.orc_warrior_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de Ironhead";
		this.m.Description = "Como qualquer veterano da batalha de muitos nomes pode atestar, lutar contra um guerreiro Orc é lutar contra uma verdadeira parede de metal e carne, aparentemente impermeável a até mesmo a mais debilitante de golpes.Com esta poção, agora você pode ser aquela parede!";
		this.m.IconLarge = "";
