this.lindwurm_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Tintura de Emberblood";
		this.m.Description = "Sinta seu sangue ferver!Ou, mais ao ponto, não!Com esta tintura, o sangue queimado de um Lindwurm fluirá através de veias decididamente humanas, com o assunto da sorte nenhum o mais sábio.Até que eles comecem a sangrar, é claro.";
		this.m.IconLarge = "";
