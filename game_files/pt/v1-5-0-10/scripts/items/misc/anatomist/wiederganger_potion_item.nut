this.wiederganger_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de pele de couro";
		this.m.Description = "Quando consumido, esta poderosa mistura altera a carne para reagir imediatamente a golpes repentinos, protegendo o corpo de ferimentos graves!Não se importa com o cheiro, que é apenas um sinal de sua potência.";
		this.m.IconLarge = "";
