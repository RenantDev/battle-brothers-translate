this.honor_guard_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Elixir de Boneflesh.";
		this.m.Description = "Os mortos-vivos são justamente temidos por seu propósito inabalável e sua vontade inquebrável, mas qualquer guerreiro experiente sabe de um terceiro horror, a resistência das criaturas do medo a lanças e flechas.Com esta mistura, a vida também pode obter esse aegis!";
		this.m.IconLarge = "";
