this.research_notes_greenskins_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Notas de pesquisa Greenskin";
		this.m.Description = "Uma coleção arrumada de relatórios de testemunhas oculares, logs de experimento e diários de pesquisa detalhando a anatomia de vários espécimes de greenskin.";
