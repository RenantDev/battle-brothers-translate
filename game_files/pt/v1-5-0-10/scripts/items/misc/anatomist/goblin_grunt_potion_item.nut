this.goblin_grunt_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de Fleetfoot";
		this.m.Description = "Desenvolvido a partir de drogas encontradas em tropas de linha de frente goblin, esta mistura pode conceder um homem a celeridade tipicamente encontrada nos greenskins diminutivos.Pode resultar em descoloração menor da pele.";
		this.m.IconLarge = "";
