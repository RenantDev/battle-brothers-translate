this.research_notes_legendary_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Livro de Legends.";
		this.m.Description = "Um diário magro ligado em couro fino, contendo suas escassas notas científicas sobre criaturas de mito e lenda.";
