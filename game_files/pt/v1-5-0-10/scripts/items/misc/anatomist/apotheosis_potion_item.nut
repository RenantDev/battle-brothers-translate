this.apotheosis_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de Apotheose.";
		this.m.Description = "Esta fantástica mistura é o auge de que pesquisa sobre anatomia humana produziu.Os poucos que sabem de sua existência afirmam que consumir que é subir a um estado mais elevado de ser, algo além de um mero humano.";
		this.m.IconLarge = "";
