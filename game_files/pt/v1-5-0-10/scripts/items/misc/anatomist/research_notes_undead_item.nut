this.research_notes_undead_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Ledger dos mortos";
		this.m.Description = "Um livro recheado de folclóricos, pós-mortems, notas de autópsia e os rabiscos loucos de um suposto necromante que conter coletivamente o seu conhecimento dos mortos-vivos.";
