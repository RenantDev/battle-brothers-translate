this.ancient_priest_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Description = "Esta poção se transformará até mesmo a mais amarela "inchaço de homens em uma verdadeira fonte de coragem.Não importa as probabilidades ou o inimigo, eles permanecerão tranquilos!Os efeitos colaterais podem incluir perda de vida devido a ser incapaz de recuar quando a situação exige isso.";
		this.m.IconLarge = "";
