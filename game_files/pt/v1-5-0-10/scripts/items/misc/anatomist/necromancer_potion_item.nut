this.necromancer_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "O rei em correntes";
		this.m.Description = "Das muitas armas à disposição de um homem, a mais mortal é certamente sua mente, e em nenhuma figura é mais aparente do que o necromante temido.Com esta mistura, esse intelecto assustador pode descer para a compreensão do homem comum!";
		this.m.IconLarge = "";
