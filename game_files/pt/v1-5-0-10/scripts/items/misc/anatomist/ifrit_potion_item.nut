this.ifrit_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção de Stoneskin";
		this.m.Description = "Com esta poção, um homem comum pode assumir o aspecto daquele mais assustador dos inimigos, a IFRIT dos desertos do sul!Ganhe a pele dos diabos e ria em seus inimigos enquanto eles quebram suas armas sobre você!Os efeitos colaterais podem incluir coceira.";
		this.m.IconLarge = "";
