this.goblin_overseer_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Deadyee \ 's Draft";
		this.m.Description = "Peças iguais aterrorizantes e irritantes, a marcha estranha dos goblins de casta superior tem sido considerada inovadora por humanos comuns e autoconscientes.Com esta poção maravilhosa, no entanto, o guerreiro exigente pode aproveitar parte dessa habilidade latente para si a um menor custo cosmético!";
		this.m.IconLarge = "";
