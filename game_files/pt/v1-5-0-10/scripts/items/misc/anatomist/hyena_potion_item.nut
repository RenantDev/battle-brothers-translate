this.hyena_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Description = "Fabricado com uma glândula anteriormente desconhecida da Hiena do Deserto Savage, esta bravura saudável transforma até mesmo o homem frágil em uma fonte de resistência.Mesmo o mais grave das feridas vai parar de sangrar e fechar em uma fração do tempo.";
		this.m.IconLarge = "";
