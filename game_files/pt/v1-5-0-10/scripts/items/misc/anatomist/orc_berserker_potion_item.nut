this.orc_berserker_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Filtro diário";
		this.m.Description = "Desenvolvido a partir das glândulas supra-renais de tão chamadas orc \ 'Berserkers \', esta mistura é tão nomeada para o estado emocional aumentado e a tonalidade avermelhada de quem bebe.";
		this.m.IconLarge = "";
