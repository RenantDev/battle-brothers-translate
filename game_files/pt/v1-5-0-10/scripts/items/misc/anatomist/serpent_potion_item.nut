this.serpent_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Poção Quickfang.";
		this.m.Description = "Com esta poção, o temido guista e precisão da serpente do deserto odioso está dentro de qualquer garantia de Warrior!";
		this.m.IconLarge = "";
