this.research_notes_beasts_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Tome de bestas.";
		this.m.Description = "Um tratado sobre os bestas do mundo.Notas codificadas preenchem as margens nas seções sobre as mais interessantes - e as verdadeiras criaturas.";
