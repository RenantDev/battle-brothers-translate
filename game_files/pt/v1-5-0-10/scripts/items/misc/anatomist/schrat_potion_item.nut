this.schrat_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	...
	function create()
	{
		...
		this.m.Name = "Rascunho de raízes Godtree";
		this.m.Description = "Com esta mistura maravilhosa, meros homens mortais assumirão um aspecto dos próprios deuses!Quem consome que pode ficar enraizado como solidamente as grandes Godtrees de Legenda.";
		this.m.IconLarge = "";
