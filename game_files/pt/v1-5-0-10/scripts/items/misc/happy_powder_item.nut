this.happy_powder_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Name = "Pó feliz";
		this.m.Description = "Este pó milagroso transforma instantaneamente um mercenário mal-humorado e mal-humorado em um feliz e energético.Não opere maquinaria pesada enquanto sob a influência.";
