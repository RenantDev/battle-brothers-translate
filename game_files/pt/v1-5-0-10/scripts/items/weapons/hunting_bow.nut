this.hunting_bow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Arco de caça";
		this.m.Description = "Um arco refinado geralmente usado para caçar animais.Mortal contra alvos não ármados, mas requer alguma experiência para usar efetivamente.";
