this.battle_whip <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um longo chicote com uma ponta farpada que pode rasgar feridas terríveis sobre sangramento sobre uma faixa significativa, mas é muito ineficiente contra armadura.";
