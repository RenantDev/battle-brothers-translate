this.hooked_blade <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Lâmina viciada";
		this.m.Description = "Uma ferramenta agrícola adaptada para uso em batalha, esta Polearm tem uma lâmina enganchada para atacar uma distância e puxar em alvos.";
