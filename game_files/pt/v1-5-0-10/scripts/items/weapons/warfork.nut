this.warfork <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Warfork.";
		this.m.Description = "Um forcado re-forjado em uma arma de campo de batalha que é uma cruz entre uma lança e um pique.Usado para empurrar sobre alguma distância e manter o inimigo à distância.";
