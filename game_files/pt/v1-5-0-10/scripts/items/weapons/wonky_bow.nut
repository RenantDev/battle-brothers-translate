this.wonky_bow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Arco de Wonky";
		this.m.Description = "Um arco mal concebido se você já viu um.As fragmilhas de madeira e rachaduras quando dobradas, a string frizzes e vai, soma, toda vez que você recue.";
