this.crypt_cleaver <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Cutelo de cripta";
		this.m.Description = "Uma lâmina pesada com uma extremidade estranhamente curva, combinando as qualidades da espada e machuca em um cutelo de duas mãos devastador.";
