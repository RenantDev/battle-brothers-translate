this.ancient_sword <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Espada antiga";
		this.m.Description = "Uma lâmina reta de origem antiga.O aperto é coberto por estranhas ornamentação, o que pode torná-lo valioso para historiadores e outros indivíduos acadêmicos.";
