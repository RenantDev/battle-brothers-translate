this.crossbow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Besta";
		this.m.Description = "Uma besta de alavanca de puxar que pode impulsionar os parafusos em distâncias médias.Eficaz mesmo nas mãos dos leigos, mas requer quase uma vez completa para recarregar.";
