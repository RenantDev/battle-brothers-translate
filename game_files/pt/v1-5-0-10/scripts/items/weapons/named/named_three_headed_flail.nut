this.named_three_headed_flail <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma arma muito rara construída a partir de materiais valiosos e fortes.Apesar de sua aparência cerimonial, faz uma ferramenta aterrorizante de destruição.";
