this.named_polemace <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma arma crua como uma polemace também pode ser elaborada com paixão, habilidade e atenção aos detalhes, pois este exemplar apresenta impressionantemente.";
