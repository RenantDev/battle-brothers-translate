this.named_khopesh <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma lâmina curva elegante que é montada em um aperto ricamente ornado.Peças como esta foram perdidas por séculos e são ditas agora para a altura do império.";
