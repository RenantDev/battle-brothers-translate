this.named_throwing_axe <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Pequenos eixos a serem jogados em um movimento sobrevivente em direção a um alvo.Esses são especialmente bem equilibrados e hardy o suficiente para infligir danos graves à armadura e escudos do intervalo.";
