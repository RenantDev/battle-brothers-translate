this.named_billhook <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma arma como uma lâmina de golpear por alguma distância e um gancho anexado para puxar os alvos.O Smith que forjou essa arma certamente sabia o que estava fazendo.";
