this.named_goblin_heavy_bow <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Goblins sabem como artesanato e arcos de luz.Esta peça, feita de alguma madeira clara desconhecida, tem surpreendente poder puxando apesar de seu pequeno tamanho.";
