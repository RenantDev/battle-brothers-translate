this.named_battle_whip <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um chicote é bastante a arma peculiar, mas esta peça foi elaborada por um verdadeiro mestre.É mais durável e equilibrado do que qualquer outro que você viu.";
