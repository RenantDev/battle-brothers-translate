this.named_skullhammer <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Este martelo bruto e pesado é decorado com crânios adicionais de animais como se já não é impressionante o suficiente.Como uma cabeça de Ram, ele vai esmagar o alvo.";
