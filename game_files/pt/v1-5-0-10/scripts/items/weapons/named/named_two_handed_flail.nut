this.named_two_handed_flail <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Este impressionante flail de duas mãos tem pouco deixado em comum com a ferramenta agrícola que se origina.Parece ter sido projetado por um lutador experiente e construído por um artesão extraordinariamente qualificado.";
