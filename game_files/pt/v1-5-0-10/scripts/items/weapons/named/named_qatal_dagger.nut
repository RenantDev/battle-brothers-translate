this.named_qatal_dagger <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma lâmina curva requintadamente criada, usada notoriamente por assassinos dos desertos do sul.Particularmente eficaz contra alvos já debilitados.";
