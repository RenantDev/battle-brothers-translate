this.named_greataxe <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um machado longo e de duas mãos projetado para batalha que suporta pesado com cada balanço e pode facilmente cortar um homem em dois.";
