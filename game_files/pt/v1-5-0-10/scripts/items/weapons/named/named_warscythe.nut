this.named_warscythe <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um poste longo ligado a uma lâmina curva afiada, usada para entregar greves de varrimento profundas ao longo de alguma distância.Este exemplar é particularmente bem trabalhado.";
