this.named_crossbow <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma besta de alavanca de puxar que pode impulsionar os parafusos em distâncias médias.Eficaz mesmo nas mãos dos leigos, mas requer quase uma vez completa para recarregar.Bem equilibrado e com tênis extraordinariamente fortes, esta arma é verdadeiramente o trabalho de um artesão mestre.";
