this.named_flail <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma cabeça marcante separada anexada a uma alça por uma corrente.Uma arma bastante imprevisível, mas útil para atacar ou ao redor da tampa de escudo.Este crachado em particular parece ainda mais aterrorizante devido às suas características únicas.";
