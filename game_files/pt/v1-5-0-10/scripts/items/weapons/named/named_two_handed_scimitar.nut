this.named_two_handed_scimitar <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma cimitarra muito grande empunhada com as duas mãos.A lâmina curva se chama através de qualquer inimigo, e a lâmina é surpreendentemente bem equilibrada por seu tamanho.";
