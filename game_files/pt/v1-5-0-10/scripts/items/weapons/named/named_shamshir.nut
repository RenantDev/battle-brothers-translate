this.named_shamshir <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um Shamshir já é uma arma requintada e exótica nessas partes, mas esta peça é de qualidade extraordinária.Ele vai cortar carne e osso tão facilmente quanto através de um melão maduro.";
