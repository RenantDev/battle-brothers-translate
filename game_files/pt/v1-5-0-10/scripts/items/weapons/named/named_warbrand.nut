this.named_warbrand <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma variante magistramente elaborada e um pouco incomum da espada com uma lâmina longa e fina, afiada apenas de um lado, e sem crossguard.Pode ser usado tanto para barras rápidas e greves varríveis.";
