this.named_two_handed_mace <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma grande movimentação de duas mãos nascida na Fiery Smithy de um verdadeiro mestre.Apesar de sua cabeça maciça, a arma é bem equilibrada e razoavelmente fácil de lidar com um indivíduo experiente.";
