this.named_two_handed_spiked_mace <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um maço pesado crafted para se assemelhar a um crânio humano.Apesar de sua aparência bruta, esta é uma arma bem equilibrada e mortal.";
