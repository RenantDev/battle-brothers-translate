this.named_cleaver <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um smith magistral conseguiu criar esse cutelo militar de uma forma que lida quase como uma espada regular, mas perde nada de seu poder devastador.";
