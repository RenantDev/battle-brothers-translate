this.named_polehammer <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma arma crua como um polegar também pode ser trabalhada com paixão, habilidade e atenção aos detalhes, pois este exemplar apresenta impressionantemente.";
