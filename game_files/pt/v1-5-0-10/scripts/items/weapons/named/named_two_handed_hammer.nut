this.named_two_handed_hammer <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um massivo martelo que é surpreendentemente bem equilibrado, apesar de seu enorme peso.O que falta na graça, compõe-se em força bruta, pois é usado para quebrar linhas inimigas até fortemente blindadas, batendo as pessoas para longe ou para o chão.";
