this.named_swordlance <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um poste longo ligado a uma lâmina curva afiada e finamente equilibrada, usada para entregar greves de varrimento profundamente ao longo de alguma distância.";
