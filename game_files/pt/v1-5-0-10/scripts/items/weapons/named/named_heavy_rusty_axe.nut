this.named_heavy_rusty_axe <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Este machado pesado e ornado pertencia a um membro valioso de uma tribo bárbara.Suas decorações e artesanato relativamente alto são uma descoberta rara entre os guerreiros selvagens do norte.";
