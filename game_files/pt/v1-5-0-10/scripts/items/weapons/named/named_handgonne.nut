this.named_handgonne <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um barril de ferro fundido com uma longa alça de madeira.Ele dispara estilhaços em um cone e pode atingir vários alvos com um tiro.Não pode ser usado enquanto estiver envolvido em corpo a corpo.";
