this.named_pike <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um longo pique usado para empurrar por alguma distância e manter o inimigo à distância.Este pique em particular é habilmente criado de madeira flexível que pode dobrar, mas nunca se encaixa, e a ponta de metal consiste em uma liga raramente vista nessas partes do mundo.";
