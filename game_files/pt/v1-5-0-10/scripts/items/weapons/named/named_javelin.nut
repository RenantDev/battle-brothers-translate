this.named_javelin <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um par de lanças de jogador de luz que são habilmente equilibradas para voar tão direta quanto possível.Tem alcance limitado e é exaustivo para jogar, mas pode infligir lesões devastadoras.";
