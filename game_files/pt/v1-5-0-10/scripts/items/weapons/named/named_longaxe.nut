this.named_longaxe <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma lâmina relativamente fina em um eixo muito longo usado para ataques de corte devastadores ao longo de alguma distância, e para renderizar escudos inutilizáveis por trás da linha de frente.Este longaxe deve ser o trabalho de um artesão extraordinário.";
