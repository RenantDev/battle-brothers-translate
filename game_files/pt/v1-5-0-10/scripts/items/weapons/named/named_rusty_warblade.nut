this.named_rusty_warblade <- this.inherit("scripts/items/weapons/named/named_weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Essa guerra enorme e excepcionalmente bem trabalhada é coberta com runas e decorações que são típicas para as tribos bárbaras do norte.";
