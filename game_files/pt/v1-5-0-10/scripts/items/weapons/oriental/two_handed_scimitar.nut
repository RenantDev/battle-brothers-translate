this.two_handed_scimitar <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Cimitarra de duas mãos";
		this.m.Description = "Uma grande cimitarra empunhada com as duas mãos.A lâmina curva se chama através de qualquer inimigo.";
