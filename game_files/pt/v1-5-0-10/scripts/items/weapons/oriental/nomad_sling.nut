this.nomad_sling <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Sling Nomad.";
		this.m.Description = "Um estilingue de couro em uma equipe reforçada de metal, usada para arremessar pedras no inimigo.Com pedras abundantes em todos os lugares, nunca ficará sem munição.";
