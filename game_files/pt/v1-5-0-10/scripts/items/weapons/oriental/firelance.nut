this.firelance <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Lança de incêndio";
		this.m.Description = "Uma lança do projeto do sul com uma carga explosiva que navegará fogo sobre duas telhas quando inflamadas.A acusação é utilizável apenas uma vez por batalha, mas recarregada automaticamente após a batalha.";
