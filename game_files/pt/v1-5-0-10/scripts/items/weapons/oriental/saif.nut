this.saif <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Saif.";
		this.m.Description = "Uma espada curva normalmente encontrada apenas nos alcances do sul.Excelente para cortar, mas não para empurrar ou armadura penetrante.";
