this.qatal_dagger <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Adaga Qatal.";
		this.m.Description = "Uma lâmina curva notoriamente usada por assassinos dos desertos do sul.Particularmente eficaz contra alvos já debilitados.";
