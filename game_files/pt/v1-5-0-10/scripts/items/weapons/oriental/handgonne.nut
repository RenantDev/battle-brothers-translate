this.handgonne <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um barril de ferro com uma alça longa de madeira.Ele dispara estilhaços em um cone e pode atingir vários alvos com um tiro.Não pode ser usado enquanto estiver envolvido em corpo a corpo.";
