this.woodcutters_axe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Machado de woodcutter";
		this.m.Description = "Um machado longo e de duas mãos que suporta pesado com todos os balanços.Realizada com as duas mãos, é usado para reduzir grandes árvores, mas também reduzirá os homens.";
