this.two_handed_hammer <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Martelo de duas mãos";
		this.m.Description = "Um martelo grande e pesado realizado com as duas mãos.O que falta na graça, compõe-se em força bruta, pois é usado para quebrar linhas inimigas até fortemente blindadas, batendo as pessoas para longe ou para o chão.";
