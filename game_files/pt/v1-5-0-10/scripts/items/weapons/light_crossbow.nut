this.light_crossbow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Crossbow claro.";
		this.m.Description = "Uma variante mais clara de uma besta de alavanca de puxar que pode impulsionar os parafusos em distâncias médias.Eficaz mesmo nas mãos dos leigos, mas requer quase uma vez completa para recarregar.";
