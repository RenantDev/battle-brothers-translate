this.heavy_crossbow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Crossbow pesado";
		this.m.Description = "Uma besta pesada com uma manivela que pode impulsionar os parafusos em distâncias médias e é eficaz mesmo contra alvos fortemente blindados.Requer quase uma vez completa para recarregar.";
