this.javelin <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pacote de Javelins.";
		this.m.Description = "Um par de lanças de jogador de luz geralmente carregadas por escaramisadores.Tem alcance limitado e é exaustivo para jogar, mas pode infligir lesões devastadoras.";
