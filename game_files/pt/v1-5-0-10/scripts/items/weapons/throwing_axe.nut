this.throwing_axe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pacote de machados de arremesso";
		this.m.Description = "Pequenos eixos a serem jogados em um movimento sobrevivente em direção a um alvo.Pesado o suficiente para infligir danos sérios à armadura e escudos do intervalo.";
