this.pickaxe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Picareta";
		this.m.Description = "Uma cabeça dura feita de metal ligada a uma alça de madeira, a picareta é uma ferramenta de mineiro usada para quebrar rochas.Como uma arma improvisada, ela não gosta, mas pode entregar lesões fatais até mesmo através da armadura.";
