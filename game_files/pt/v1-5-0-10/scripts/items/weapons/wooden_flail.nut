this.wooden_flail <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pedaço de madeira";
		this.m.Description = "Duas grandes varas fixadas com uma corrente curta, o crachá de madeira é uma ferramenta agrícola usada para atacar pilhas de grãos para soltar as cascas.Como uma arma improvisada, é bastante imprevisível, mas útil para atacar ou ao redor da tampa de escudo.";
