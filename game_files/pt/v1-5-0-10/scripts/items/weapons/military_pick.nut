this.military_pick <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pick militar";
		this.m.Description = "Um eixo de madeira com uma cabeça de metal longo e pontudo projetada para perfurar a mais robusta das armaduras.";
