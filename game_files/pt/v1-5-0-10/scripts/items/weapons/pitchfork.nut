this.pitchfork <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma ferramenta agrícola com uma alça longa e dentes pontiagudos usados para levantar e colocar palha.Como uma arma improvisada, pode ser usada para manter um adversário na baía, mas não vai infligir os mais mortíferos das lesões e se apresentará mal contra armadura.";
