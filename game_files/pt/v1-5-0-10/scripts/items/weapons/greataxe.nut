this.greataxe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Um machado pesado e longo de duas mãos projetado para a batalha que suporta pesado com cada balanço e pode facilmente cortar um homem em dois.";
