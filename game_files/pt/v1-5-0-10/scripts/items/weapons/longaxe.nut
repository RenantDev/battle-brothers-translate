this.longaxe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Demorada";
		this.m.Description = "Uma lâmina relativamente fina em um eixo muito longo usado para ataques de corte devastadores ao longo de alguma distância, e para renderizar escudos inutilizáveis por trás da linha de frente.";
