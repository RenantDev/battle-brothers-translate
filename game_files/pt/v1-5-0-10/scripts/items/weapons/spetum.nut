this.spetum <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Cuspir";
		this.m.Description = "Uma cruz entre uma lança e um lúcio, fazendo uma boa arma defensiva.Usado para empurrar sobre alguma distância e manter o inimigo à distância.";
