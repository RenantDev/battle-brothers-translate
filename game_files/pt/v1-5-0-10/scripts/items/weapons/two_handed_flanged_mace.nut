this.two_handed_flanged_mace <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Mace flangeada de duas mãos";
		this.m.Description = "Uma grande e pesada maça alada segura com as duas mãos.Receber um golpe desta arma deixará alguém atordoado e ofegante para o ar, não importa sua armadura.";
