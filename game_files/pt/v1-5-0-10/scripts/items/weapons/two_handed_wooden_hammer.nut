this.two_handed_wooden_hammer <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Malho de duas mãos";
		this.m.Description = "Um grande malho de madeira que é realizado com as duas mãos.Pode causar golpes devastadores que podem bater até inimigos blindados ou para o chão.";
