this.orc_cleaver <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Chopper principal";
		this.m.Description = "Um fragmento forte e bruto de metal com um aperto embrulhado parecido com uma espada, mas muito mais pesado.Não feita para as mãos humanas.";
