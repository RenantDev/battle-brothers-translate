this.orc_javelin <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pacote de Docos Crusos";
		this.m.Description = "Um monte de dores grossos destinados a jogar em alvos.Tem alcance limitado e é exaustivo para jogar, mas pode infligir lesões devastadoras.Também pode infligir danos menores aos escudos se aqueles são atingidos.";
