this.orc_flail_2h <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Cadeia de berserk";
		this.m.Description = "Uma enorme corrente de ferro com uma cabeça de metal completa cravada no final.Muito pesado para ser usado efetivamente pelo humano médio.";
