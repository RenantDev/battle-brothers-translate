this.goblin_staff <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pessoal gnarly.";
		this.m.Description = "Uma equipe gnarly esculpida em madeira velha e dura, adornada com ossos e penas.Pode ser de interesse para colecionadores.";
