this.goblin_crossbow <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Impaler cravado";
		this.m.Description = "Uma besta grande e pesada com picos ameaçadores na frente.Mais como um balista em miniatura, atira estacas com força suficiente para derrubar um atingido alvo.";
