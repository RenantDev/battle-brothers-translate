this.orc_axe_2h <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Splitter do homem";
		this.m.Description = "Um enorme e crudamente construído duplo battleaxe muito pesado para ser usado efetivamente pelo humano médio.";
