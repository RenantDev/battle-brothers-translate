this.morning_star <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Estrela da Manhã";
		this.m.Description = "Um eixo de madeira com uma cabeça de metal cravada usada para entregar uma combinação de golpes de força e perfuração.";
