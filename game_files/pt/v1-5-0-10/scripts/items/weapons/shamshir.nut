this.shamshir <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Espada";
		this.m.Description = "Esta lâmina exótica bem trabalhada do sul tem uma borda curva que permite cortar feridas profundas com facilidade, mas torna menos adequada para empurrar e penetrante armadura.Um encontro raro nessas terras.";
