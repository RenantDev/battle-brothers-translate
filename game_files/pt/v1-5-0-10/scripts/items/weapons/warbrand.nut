this.warbrand <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Description = "Uma variante de duas mãos da espada com uma lâmina longa e fina, afiada apenas de um lado e sem crossguard.Pode ser usado tanto para barras rápidas e greves varríveis.";
