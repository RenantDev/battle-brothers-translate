this.two_handed_mace <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Mace de duas mãos";
		this.m.Description = "Um enorme clube de madeira com uma cabeça cravada.Receber um golpe desta arma deixará alguém atordoado e ofegante para o ar, não importa sua armadura.";
