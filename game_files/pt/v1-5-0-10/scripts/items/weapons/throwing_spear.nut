this.throwing_spear <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Jogando lança";
		this.m.Description = "Mais leve que uma lança comum, mas mais pesado que um dardo, esta arma destina-se a ser lançada em distâncias curtas.A ponta se dobrará no impacto, potencialmente renderizar escudos inutilizáveis.Pode ser usado contra oponentes não blindados também para um grande efeito.";
