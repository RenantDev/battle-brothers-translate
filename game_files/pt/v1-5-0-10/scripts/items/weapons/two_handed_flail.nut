this.two_handed_flail <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Flail de duas mãos";
		this.m.Description = "Um grande e pesado crachá de metal que requer duas mãos para usar.Útil para atacar ou ao redor da tampa de escudo.";
