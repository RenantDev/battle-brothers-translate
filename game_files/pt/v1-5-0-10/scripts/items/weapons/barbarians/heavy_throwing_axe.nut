this.heavy_throwing_axe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Pacote de eixos de arremesso pesados";
		this.m.Description = "Machados de arremesso pesados e desajeitados usados pelos bárbaros do norte.Difícil de jogar e bater, mas mortal.";
