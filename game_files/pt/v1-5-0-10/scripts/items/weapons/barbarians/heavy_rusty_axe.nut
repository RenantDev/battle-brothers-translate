this.heavy_rusty_axe <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Machado enferrujado pesado";
		this.m.Description = "Este pesado machado enferrujado funciona mais pelo seu peso do que sua nitidez, mas faz o trabalho, no entanto.";
