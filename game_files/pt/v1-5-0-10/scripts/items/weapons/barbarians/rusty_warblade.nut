this.rusty_warblade <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Warblade enferrujado";
		this.m.Description = "Uma lâmina pesada com uma extremidade curva combinando espada e machado em um cutelo de duas mãos devastador.";
