this.thorned_whip <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Chicote espinhoso";
		this.m.Description = "Um chicote espinhoso robusto.Usado por bárbaros tanto em batalha como para rebanhos animais selvagens, até mesmo o maior dos quais se apaixonará de sua rachadura.";
