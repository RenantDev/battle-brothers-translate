this.three_headed_flail <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Flail de três cabeças";
		this.m.Description = "Três cabeças impressionantes separadas anexadas a uma alça por correntes.Cada cabeça pode acertar ou perder um alvo separadamente e atacar ou ao redor da tampa de escudo.";
