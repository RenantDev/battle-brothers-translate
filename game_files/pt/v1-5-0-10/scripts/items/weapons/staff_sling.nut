this.staff_sling <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Sling de pessoal";
		this.m.Description = "Uma estilingue de couro em uma equipe, usada para arremessar pedras no inimigo.Com pedras abundantes em todos os lugares, nunca ficará sem munição.";
