this.flail <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.Name = "Crítico";
		this.m.Description = "Uma cabeça marcante separada anexada a uma alça por uma corrente.Uma arma bastante imprevisível, mas útil para atacar ou ao redor da tampa de escudo.";
